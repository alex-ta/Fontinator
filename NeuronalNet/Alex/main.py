...
# load dataset
real_x,real_y = loader.read_to_xy_array("C:/Users/Alex/Downloads/images", flatten=0, print_out=0)
...
result = model.fit(train_x, train_y, epochs=2, batch_size=10)#, callbacks=[logger])
